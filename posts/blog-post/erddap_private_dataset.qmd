...
description: "Instruction to Access a Private Dataset on ERDDAP Programmatically Using Python with Selenium"
...
This guideline shows how to automate access to a private dataset on ERDDAP using Google login and Chrome web browser.
